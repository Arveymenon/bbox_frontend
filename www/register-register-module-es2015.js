...
let RegisterPage = class RegisterPage {
    ...
    // };  
    constructor(formBuilder, authService, router, location, navController, toastController, ref, oneSignal, 
    //  private fb: Facebook,
    ...
    ngOnInit() {
        this.storage.get('temporary_mobile_number').then((mobile) => {
    ...
    onSubmit() {
        if (this.credentialsForm.valid) {
            ...
            this.userService.checkDetails(form).subscribe((res) => {
                console.log(res);
                if (res.error == false) {
                    let credentials = {
                    ...
                    this.authService.register(credentials).then((data) => {
    ...
    goToHome() {
        ...
        this.ngZone.run(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () { return yield this.navController.navigateRoot(['home/tabs/tab1']); })).then(() => {
            this.ref.detectChanges();
        });
    }
};
