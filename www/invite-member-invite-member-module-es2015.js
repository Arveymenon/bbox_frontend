...
let InviteMemberPageModule = class InviteMemberPageModule {
};
...
let InviteMemberPage = class InviteMemberPage {
    constructor(modalController, socialSharing, 
...
InviteMemberPage.ctorParameters = () => [
...
let ContactsListComponent = class ContactsListComponent {
    constructor(contacts, platform, modalController, sms, androidPermissions, alertController, toastController, translate, storage) {
    ...
    sendInviteSMS(contact) {
        this.sms.hasPermission()
            .then((permission) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (permission == true) {
...
//# sourceMappingURL=invite-member-invite-member-module-es2015.js.map