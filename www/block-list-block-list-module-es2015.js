...
let BlockListPage = class BlockListPage {
    constructor(userService, storage, loader, ref, alertController, translate, contactsService) {
    ...
    getList() {
        ...
        this.userService.getBlockList(this.user_id).subscribe((list) => {
            this.loader.dismiss();
            list.forEach(item => {
...
//# sourceMappingURL=block-list-block-list-module-es2015.js.map