...
let JoinGroupPageModule = class JoinGroupPageModule {
};
...
let JoinGroupPage = class JoinGroupPage {
    constructor(groupService, storage, router, loader) {
    ...
    getgroupuser(val) {
        ...
        this.groupService.getusergroup(val).subscribe((res) => {
            this.loader.dismiss();
            console.log(res);
    ...
    onDelete(id) {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
            ...
            if (result.value) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire(this.groupService.deleteGroup(id, postdata).subscribe((res) => {
                    this.storage.get('id').then((val) => {
                        this.getgroupuser(val);
                    });
                    'Deleted!';
...
//# sourceMappingURL=join-group-join-group-module-es2015.js.map