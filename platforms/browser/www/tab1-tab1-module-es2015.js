...
let Tab1Page = class Tab1Page {
    constructor(groupService, router, storage, ref, loader, storageService, contactsService, socket, translate, alertController, toastCtrl) {
    ...
    ngOnInit() {
        ...
        this.storage.get('id').then((userId) => {
            this.userId = userId;
            this.socket.fromEvent('notify-' + userId).subscribe((message) => {
                console.log(message);
                this.loadGroups();
            });
        });
    ...
    deleteChat(id) {
        return new Promise((resolve, reject) => {
            ...
            this.groupService.deleteChatRoom(id, body).subscribe(deleted => { resolve(true); }, err => { reject(err); });
        });
    }
    removeAlert(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    removeFromChat(id) {
        return new Promise((resolve, reject) => {
            this.groupService.removeMember({ member: this.idval }, id).subscribe(deleted => { resolve(true); }, err => { reject(err); });
        });
    }
    presentToast(text) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
