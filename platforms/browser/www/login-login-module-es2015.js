...
let LoginPage = class LoginPage {
    constructor(formBuilder, authService, router, toastController, translate, storage, oneSignal, 
    // private fb: Facebook,
    ...
    onSubmit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.credentialsForm.valid) {
                ...
                this.translate.get('Invalid_Credentials', { value: this.lang }).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    console.log(res);
