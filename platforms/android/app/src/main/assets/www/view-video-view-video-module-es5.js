...
var ViewVideoPage = /** @class */ (function () {
    function ViewVideoPage(route) {
        var _this = this;
        this.route = route;
        console.log("VIDEO");
        this.route.params.subscribe(function (params) {
            _this.video = params['video'];
            console.log(_this.video);
            // alert(this.id);
        });
    }
    ViewVideoPage.prototype.ngOnInit = function () {
    };
    ViewVideoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=view-video-view-video-module-es5.js.map