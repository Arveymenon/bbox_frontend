...
var CreateVideoChatPageModule = /** @class */ (function () {
    function CreateVideoChatPageModule() {
    }
    ...
    return CreateVideoChatPageModule;
}());
...
var CreateVideoChatPage = /** @class */ (function () {
    function CreateVideoChatPage(route, storage, router, toastCtrl, translate, groupService, userService) {
        var _this = this;
        this.route = route;
        ...
        this.route.queryParams.subscribe(function (params) {
            if (params && params.special) {
                ...
                _this.video_chat = JSON.parse(params.special).video;
                _this.group_id = JSON.parse(params.special).room_id;
                _this.room_id = _this.group_id;
                console.log(_this.group_id);
                _this.groupService.getGroupDetails(_this.group_id, _this.user_id).then(function (res) {
                    console.log(res);
                    _this.group_data = res;
                    if (res) {
                        res.memberData.forEach(function (element) {
                            if (res.memberData.length >= _this.userArray.length) {
                                _this.userArray.push({ id: element['_id'], name: element['name'], avatar: element['avatar'] });
                            }
                        });
                    }
                }, function (error) {
    ...
    CreateVideoChatPage.prototype.ngOnInit = function () {
    };
    CreateVideoChatPage.prototype.selectIndividual = function (event, pos) {
    ...
    CreateVideoChatPage.prototype.selectAll = function (event) {
        var _this = this;
        document.querySelector('.images-container').classList.toggle('overlay');
        document.querySelector('.checkmark').classList.toggle('hidden');
        document.querySelector('.all-text').classList.toggle('blue');
    ...
    CreateVideoChatPage.prototype.toggleAll = function () {
    ...
    CreateVideoChatPage.prototype.checkAll = function () {
    ...
    CreateVideoChatPage.prototype.toggleIDs = function (id, action) {
        console.log(id);
    ...
    CreateVideoChatPage.prototype.startVideoChat = function () {
        var _this = this;
        ...
        this.groupService.postVideoCall(body)
            ...
            if (_this.video_chat == 1) {
                _this.router.navigate(['video-chat/' + _this.room_id]);
            }
            else if (_this.video_chat == 0) {
                _this.router.navigate(['audio-call/' + _this.room_id]);
            }
        });
    };
    CreateVideoChatPage.prototype.presentToast = function (text) {
    ...
    CreateVideoChatPage.ctorParameters = function () { return [
...
//# sourceMappingURL=create-video-chat-create-video-chat-module-es5.js.map